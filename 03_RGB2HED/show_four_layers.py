...
img.save('h_output_image_forreport.jpg')

hed_norm2 = ihc_he / np.max(ihc_he)
arr_uint8_2 = (hed_norm2 * 255).astype(np.uint8)
img2 = Image.fromarray(arr_uint8_2, mode="RGB")
img2.save('he_output_image_forreport.jpg')
